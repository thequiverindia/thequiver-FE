...
import { Play, Pause, SkipBack, SkipForward, Bookmark, Share2 } from 'lucide-react';
            ...
            <div className="grid gap-0 md:grid-cols-5">
              ...
              <div className="flex flex-col justify-center p-6 md:col-span-3 md:p-8">
                ...
                <div className="mt-5 flex items-center justify-center gap-3">
                  <button className="inline-flex h-10 w-10 items-center justify-center rounded-full text-ink-muted hover:bg-bg-muted hover:text-ink">
                    <SkipBack className="h-5 w-5" />
                  </button>
                  <button className="inline-flex h-14 w-14 items-center justify-center rounded-full bg-ink text-bg hover:bg-ink/90">
                  ...
                  <div className="ml-3 flex items-center gap-1">
                    <button className="inline-flex h-9 w-9 items-center justify-center rounded-full text-ink-muted hover:bg-bg-muted hover:text-ink">
